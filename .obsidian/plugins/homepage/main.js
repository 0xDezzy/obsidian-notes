    ...
    display() {
        ...
        new obsidian.Setting(containerEl)
            ...
            text.setPlaceholder("Home")
                ...
                this.settings.defaultNote = obsidian.normalizePath(value || DEFAULT.defaultNote);
...
class Homepage extends obsidian.Plugin {
    ...
    setHomepageMode() {
        ...
        if (!this.settings.alwaysPreview || !(leaf.view instanceof obsidian.MarkdownView))
            return;
